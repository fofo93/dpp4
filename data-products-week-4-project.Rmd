...
## Application
 ...
 - The second half of the mentioned assignment was to develop a web application. The application was named ***MPG Prediction***. An instance is up & running at <https://laplata2003.shinyapps.io/data-products-week-4-project/>.
 ...
 - The application and the current presentation source codes can be found at <https://github.com/laplata2003/data-products-week-4-project>. The application comprises 3 files: *ui.R* (UI), *server.R* (backend) and *modelBuilding.R* (Random Forest predictor).
